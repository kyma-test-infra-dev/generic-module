...
public final class ServiceMappingOperatorServiceAccount extends ServiceMappingsDependentResource<ServiceAccount> {

	public ServiceMappingOperatorServiceAccount(KubernetesClient kubernetesClient) {
	...
	protected String getDependentResourceName(ConnectivityProxy connectivityProxy) {
		return connectivityProxy.serviceMappingsServiceAccountName();
	}
