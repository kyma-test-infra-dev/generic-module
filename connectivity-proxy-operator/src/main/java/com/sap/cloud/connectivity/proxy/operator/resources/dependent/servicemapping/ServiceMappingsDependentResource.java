package com.sap.cloud.connectivity.proxy.operator.resources.dependent.servicemapping;
...
public abstract class ServiceMappingsDependentResource<R extends HasMetadata> extends ConnectivityProxyDependentResource<R> {

	protected ServiceMappingsDependentResource(Class<R> resourceType, KubernetesClient kubernetesClient) {
